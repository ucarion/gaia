...
//     polygon_indices: BTreeMap<
//         (u8, u64),
//         (gfx_draping::PolygonBufferIndices,
...
//                 let indices = polygon_buffers[level].add(&gfx_draping::Polygon::new(
//                     polygon.bounding_box,
//                     points.clone(),
//                 ));
//                 polygon_indices.insert((level as u8, polygon_id as u64), (
//                     indices,
//                     polygon.properties.clone(),
//                 ));
//             }
//         }
...
//                 let (ref _indices, ref properties) =
//                     self.polygon_indices[&(level_of_detail, *polygon_id)];
//                 let color = properties["MAPCOLOR13"].as_f64().unwrap() as u8;
//                 let &mut (ref mut polygon_ids, ref mut min_z, ref mut max_z) =
//                     polygon_color_groups.entry(color).or_insert((
//                         Vec::new(),
//                         f32::INFINITY,
//                         f32::NEG_INFINITY,
//                     ));
...
//                     let (ref indices, ref _properties) =
//                         self.polygon_indices[&(level_of_detail, *polygon_id)];
